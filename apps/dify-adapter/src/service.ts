  ...
  private toDifyRecord(
    ...
    return {
      ...
      metadata: {
        ...
        qa_generated_mode: stringOrNull(result.metadata.qa_generated_mode),
        asset_id: stringOrNull(result.metadata.asset_id),
        asset_binding_id: stringOrNull(result.metadata.asset_binding_id),
        segment_attachment_id: stringOrNull(result.metadata.segment_attachment_id),
        asset_kind: stringOrNull(result.metadata.asset_kind),
        asset_filename: stringOrNull(result.metadata.asset_filename),
        asset_mime_type: stringOrNull(result.metadata.asset_mime_type),
        asset_preview_url: stringOrNull(result.metadata.asset_preview_url),
        source_url: stringOrNull(result.metadata.source_url),
        doc_type: stringOrNull(result.metadata.doc_type),
        attachment_info: toRecord(result.metadata.attachment_info),
        source_chunk_id: stringOrNull(result.metadata.source_chunk_id),
        image_vector_enabled: result.metadata.image_vector_enabled === true,
        image_vector_source: stringOrNull(result.metadata.image_vector_source),
        image_vector_fallback_reason: stringOrNull(result.metadata.image_vector_fallback_reason),
        asset_match_text: stringOrNull(result.metadata.asset_match_text),
        score,
