...
const ZH_CN_TRANSLATIONS: Record<string, string> = {
  ...
  Permissions: "权限",
  "Space permissions": "空间权限",
  "Knowledge base permissions": "知识库权限",
  "Document permissions": "文档权限",
  "Document permission": "文档权限",
  "Share document": "分享文档",
  "Knowledge base visibility": "知识库公开性",
  "Save visibility": "保存公开性",
  "Save permission": "保存权限",
  "Permission mode": "权限模式",
  "Document visibility": "文档公开性",
  "Only collaborators": "仅协作者",
  "Space members": "空间成员",
  Public: "公开",
  "Only explicit collaborators can read private content.": "只有显式协作者可以读取私有内容。",
  "Space members can read workspace-visible content.": "空间成员可以读取空间成员可见内容。",
  "Anyone with access to the instance can read public content.":
    "可访问本实例的用户可以读取公开内容。",
  "Visibility decides who can read the knowledge base before collaborator roles are considered.":
    "公开性决定协作者角色之外，谁可以读取这个知识库。",
  "Knowledge base visibility saved.": "知识库公开性已保存。",
  "Visibility update failed.": "公开性更新失败。",
  "Document permission saved.": "文档权限已保存。",
  "Permission update failed.": "权限更新失败。",
  "Documents inherit knowledge base visibility by default. Use custom permission only when this document needs an exception.":
    "文档默认继承知识库公开性。只有这篇文档需要例外时，才使用自定义权限。",
  "Inherit knowledge base permission": "继承知识库权限",
  "Custom document permission": "自定义文档权限",
  "Space member roles": "空间成员角色",
  "Content collaborator roles": "内容协作者角色",
  "Space owner can manage the space, members, and all space settings.":
    "空间 owner 可以管理空间、成员和空间设置。",
  "Space admin can manage members and shared space settings.":
    "空间管理员可以管理成员和共享空间设置。",
  "Space member can access workspace-visible knowledge bases.":
    "空间成员可以访问空间成员可见的知识库。",
  "Space guest has limited space visibility and needs content permission.":
    "空间访客只有有限空间可见性，读取内容仍需要内容权限。",
  "Content owner keeps full management authority.": "内容 owner 拥有完整管理权限。",
  "Manager can manage content settings and collaborators.": "管理者可以管理内容设置和协作者。",
  "Editor can read and edit content.": "编辑者可以读取和编辑内容。",
  "Viewer can read content only.": "查看者只能读取内容。",
  "Workspace invitations grant admin, member, or guest roles.":
    "空间邀请授予 admin、member 或 guest 角色。",
  "Content invitations grant manager, editor, or viewer roles. Owner is not granted by ordinary invitation.":
    "内容邀请授予 manager、editor 或 viewer 角色；普通邀请不会授予 owner。",
  accepted: "已接受",
  admin: "管理员",
  ...
  "Personal space": "个人空间",
  "Team space": "团队空间",
  "Your personal space keeps your own knowledge bases and recent activity.":
    "个人空间用于放自己的知识库和最近活动。",
  "Team spaces collect shared knowledge bases and collaboration activity.":
    "团队空间用于多人共享知识库和协作活动。",
  "My knowledge bases": "我的知识库",
  "Space knowledge bases": "空间知识库",
  "New knowledge base": "新建知识库",
  "Belonging space": "归属空间",
  Personal: "个人",
  Spaces: "空间",
  "Knowledge bases belong to one personal or team space.":
    "知识库必须归属于一个个人空间或团队空间。",
  "No writable space is available for creating a knowledge base.": "当前没有可创建知识库的空间。",
  "Create a knowledge base in this space.": "在当前空间中创建知识库。",
  "Add a page after choosing a target knowledge base.": "选择目标知识库后添加页面。",
  "Import files into a target knowledge base.": "导入文件到目标知识库。",
  "Create a knowledge base before adding documents or importing files.":
    "请先创建知识库，再添加文档或导入文件。",
  "Select New document in the document tree to add a page to this knowledge base.":
    "请在文档树中点击新建文档，为该知识库添加页面。",
  "Select Import file in the document tree to import into this knowledge base.":
    "请在文档树中点击导入文件，将文件导入该知识库。",
  "No knowledge bases in this space": "这个空间还没有知识库",
  "Create a knowledge base to start organizing documents.": "创建一个知识库来整理文档。",
  "Recent content": "最近内容",
  "Recently edited": "最近编辑",
  "Recently viewed": "最近浏览",
  "Documents you edit will appear here.": "你编辑过的文档会显示在这里。",
  "Documents you open will appear here.": "你打开过的文档会显示在这里。",
  Favorites: "收藏",
  Comments: "评论",
  "Favorites are reserved for a later phase.": "收藏会在后续阶段补齐。",
  "Comments are reserved for a later phase.": "评论会在后续阶段补齐。",
  items: "项",
  ...
  "This side panel shows the current space context. Document outline, metadata, and versions appear only after opening a document.":
    "这里显示当前空间上下文。打开具体文档后，右侧才会显示大纲、元数据和版本。",
  ...
  "Domain restriction is off. Any valid email can register if registration is enabled.":
    "邮箱域名限制已关闭。只要允许注册，任何有效邮箱都可以注册。",
  "Edit allowed email domains": "编辑允许注册的邮箱域名",
  "Add one domain per line or separate them with commas.": "每行一个域名，也可以用逗号分隔。",
  "You can enter domains like sailuntire.com, @qq.com, or user@example.org.":
    "可以填写 sailuntire.com、@qq.com 或 user@example.org，系统会统一提取域名。",
  "Save whitelist": "保存白名单",
  "Add at least one allowed email domain.": "请至少添加一个允许的邮箱域名。",
  "Add at least one allowed email domain before saving.": "保存前请至少添加一个允许的邮箱域名。",
  "Invalid email domain.": "邮箱域名格式不正确。",
...
Object.assign(ZH_CN_TRANSLATIONS, {
  ...
  "Space avatar": "空间头像",
  "Avatar color": "头像颜色",
  "Avatar initials": "头像首字",
  "No personal space yet": "暂无个人空间",
  "No team spaces yet": "暂无团队空间",
  "Team spaces are for shared knowledge bases and members.": "团队空间用于共享知识库和成员协作。",
  "Update the team space name, slug, and avatar.": "更新团队空间名称、slug 和头像。",
  "Personal space settings are managed by OpenKB in this phase.":
    "个人空间设置本阶段由 OpenKB 自动管理。",
  "Create workspace": "创建空间",
  "Knowledge bases": "知识库",
