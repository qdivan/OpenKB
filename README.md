...
当前版本处于 `v0.3.x / Phase 13`，适合本地开发、公网测试平台和私有化试跑；还不是生产 GA 版本。
...
下一批重点是分享/协作 UI、MCP/Dify key 管理、当前文档切片侧栏、复杂导入 adapter 和更完整的 Admin UI。当前本机开发移交见 [docs/23-docs-code-gap-analysis.zh-CN.md](docs/23-docs-code-gap-analysis.zh-CN.md)。
